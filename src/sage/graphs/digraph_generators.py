...
from sage.env import DIRECTG_PATH as directg_path
from sage.env import GENTOURNG_PATH as gentourng_path
...
class DiGraphGenerators():
    ...
    def tournaments_nauty(self, n,
        ...
        sp = subprocess.Popen("{0} {1}".format(gentourng_path, nauty_input),
                              shell=True,
    ...
    def nauty_directg(self, graphs, options="", debug=False):
        ...
        sub = subprocess.Popen('{0} {1}'.format(directg_path, options),
                               shell=True,
