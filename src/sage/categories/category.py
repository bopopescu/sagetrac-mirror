...
Let's request the category of some objects::
    ...
    sage: V.category()
    Category of finite dimensional vector spaces with basis over (quotient fields and infinite sets and metric spaces)
...
class CategoryWithParameters(Category):
    ...
    def _make_named_class(self, name, method_provider, cache = False, **options):
        ...
        Similarly for ``QQ`` and ``RR``::
            ...
            sage: QQ.category()
            Join of Category of quotient fields and Category of infinite sets and Category of metric spaces
            sage: RR.category()
...
class JoinCategory(CategoryWithParameters):
    ...
    def _subcategory_hook_(self, category):
        ...
        EXAMPLES::
            ...
            sage: cat = Category.join([Rings(), VectorSpaces(QuotientFields().Metric().Infinite())])
